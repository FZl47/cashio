    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phonenumber', models.CharField(blank=True, max_length=20, null=True, validators=[apps.core.utils.validators.PhonenumberValidator()], verbose_name='phonenumber')),
                ('role', models.CharField(choices=[('admin_user', 'Admin_user'), ('common_user', 'Common User')], default='common_user', max_length=15)),
